...
class SolarSystem(DirectObject):
  ...
  def __init__(self):
    ...
    base.trackball.node().setPos(0, 160, 0)
  ...
  def legend(self):
    if (self.legendFull == True):
        ...
        self.text2.destroy()
        self.text3.destroy()
        self.text4 = self.genLabelText("[L]: Legende einblenden", 0)
        self.yearCounterText = self.genLabelText(str(self.yearCounter) + " Erdenjahre vergangen", 1)
        ...
        self.upkeyText = self.genLabelText("[Pfeil Up] Geschwindigkeit erhoehen",13)
        self.downkeyText = self.genLabelText("[Pfeil Down] Geschwindigkeit verringern",14)
        self.yearCounterText = self.genLabelText(str(self.yearCounter) + " Erdenjahre vergangen", 15)
        self.text1 = self.genLabelText("Linke Maustaste: Kamera verschieben",16)
        self.text2 = self.genLabelText("Rechte Maustaste: Kamera rein- und rauszoomen",17)
        self.text3 = self.genLabelText("Mausrad: Kamerawinkel veraendern",18)
        self.legendFull = True
  ...
  def speedUp(self):
        ...
        if(self.orbit_period_earth.getPlayRate() == 1):
  ...
  def slowDown(self):
      ...
      self.orbit_period_neptun.setPlayRate(self.orbit_period_neptun.getPlayRate()-2)
      if(self.orbit_period_earth.getPlayRate() == -1):
          self.day_period_sun.setPlayRate(-self.day_period_sun.getPlayRate())
  ...
  def rotatePlanets(self):
    ...
    self.orbit_period_mars = self.orbit_root_mars.hprInterval(
      (1.5 * self.yearscale), Vec3(360, 0, 0))
    ...
    self.orbit_period_jupiter = self.orbit_root_jupiter.hprInterval(
      (1.93 * self.yearscale), Vec3(360, 0, 0))
    self.day_period_jupiter = self.jupiter.hprInterval(
      (1.4 * self.dayscale), Vec3(360, 0, 0))
